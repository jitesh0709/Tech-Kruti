...
const HeroSection = () => {
  ...
  return <section ref={sectionRef} className="relative min-h-[70vh] sm:min-h-[90vh] flex items-center hero-gradient overflow-hidden">
      ...
      <motion.div className="absolute w-48 h-48 rounded-full pointer-events-none" style={{
      ...
      <motion.div className="container-custom relative z-10" style={{ y: contentY }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 leading-relaxed animate-fade-in" style={{
          animationDelay: '0.2s'
        }}>
          ...
          animationDelay: '0.4s'
            ...
            <HoverButton onClick={() => navigate('/about')} glowColor="hsl(var(--primary))" backgroundColor="hsl(var(--primary))" textColor="hsl(var(--primary-foreground))" hoverTextColor="hsl(var(--primary-foreground))" className="group glow-box flex items-center gap-2">
              Explore Department
              <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </HoverButton>
            <HoverButton onClick={() => navigate('/contact')} glowColor="hsl(var(--primary))" backgroundColor="transparent" textColor="hsl(var(--foreground))" hoverTextColor="hsl(var(--primary))" className="border-glow">
              Contact Us
            </HoverButton>
          </div>
